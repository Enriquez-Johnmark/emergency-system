        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <?php if($_SESSION['roles'] == '3') : ?>
                    ...
                    <li class="<?= ($activePage == 'my-reports') ? 'active':''; ?>""> <a href="/my-reports"><i class="fas fa-table"></i> <span>My Reports</span></a> </li>
                ...
                <li class="<?= ($activePage == 'dispatchers') ? 'active':''; ?>"> <a href="/dispatchers"><i class="fas fa-cog"></i> <span>Dispatchers</span></a> </li>
